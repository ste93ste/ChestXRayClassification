...
from .distributions import log_standard_categorical, log_gaussian
...
class SVI(nn.Module):
    ...
    def forward(self, x, y=None):
        ...
        mu, log_var, z = self.model(xs, ys)
        
        # p(x|y,z)
        likelihood = -self.likelihood(xs, mu, log_var) / (225*225)
